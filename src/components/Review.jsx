...
import dotted from '../assets/dot-pattern.png';
const Review = () => {
    return (
        <div className="bg-white relative">
            <div className="mx-auto">
                <div className="flex flex-col items-center text-center justify-center mx-auto max-w-2xl gap-x-8 gap-y-16 border-t border-gray-200 pt-10 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                    <div className='flex justify-between w-full'>
                        <img className='h-40 w-40 object-cover transform rotate-90 ' src={dotted} alt="" />
                        <div className="mx-auto mt-14 text-center">
                            <h2 className="text-3xl font-bold tracking-tight text-[#27170c] sm:text-4xl">Reviews</h2>
