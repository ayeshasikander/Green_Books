...
const Service = () => {
  return (
    <ServiceContainer className="relative bg-[#D63F30] pt-16 pb-44 mt-[100px]">
      <div className="flex flex-col justify-center items-center text-base font-medium text-white">
        <div class="h-24 w-24 m-2 flex-shrink-0 overflow-hidden border rounded-full border-gray-200">
          <img
